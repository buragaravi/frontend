// IndentForm.jsx - copied and adapted from QuotationForm.jsx
import React, { useState, useEffect } from 'react';
import axios from 'axios';

// SVG Icons (copied from QuotationForm)
const FlaskIcon = () => (
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            className="w-full px-4 py-2 border border-[#BCE0FD] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B3861]"
            placeholder="Any additional comments for the entire indent..."
            rows="3"
          />
        </div>
        <button
