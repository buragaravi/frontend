...
const Header = () => {
  ...
  return (
    <header className="bg-[#6D123F] text-white p-4 fixed w-full z-50 shadow-lg">
      <nav className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <ul className="flex space-x-6">
            <li>
              <a href="/" className="hover:text-pink-200 transition-colors font-medium">Home</a>
            </li>
            <li>
              <a href="/unauthorized" className="hover:text-pink-200 transition-colors font-medium">Inventory</a>
            </li>
            <li>
              <a href="/unauthorized" className="hover:text-pink-200 transition-colors font-medium">Quotations</a>
            </li>
          ...
          <div className="flex space-x-4">
            <motion.button 
              ...
              className="px-4 py-2 rounded-lg bg-white text-[#6D123F] hover:bg-pink-100 transition-colors font-medium"
            >
              Login
            </motion.button>
            <motion.button 
              ...
              className="px-4 py-2 rounded-lg border-2 border-white hover:bg-white hover:text-[#6D123F] transition-colors font-medium"
            >
              Sign Up
            </motion.button>
          </div>
      ...
      {mobileMenuOpen && (
        <motion.div
          ...
          className="md:hidden bg-[#7D2250] mt-4 p-4 rounded-lg"
        >
          <ul className="space-y-3">
            <li>
              <a href="/" className="block py-2 hover:text-pink-200 transition-colors">Home</a>
            </li>
            <li>
              <a href="/unauthorized" className="block py-2 hover:text-pink-200 transition-colors">Inventory</a>
            </li>
            <li>
              <a href="/unauthorized" className="block py-2 hover:text-pink-200 transition-colors">Quotations</a>
            </li>
            
            <li className="pt-2 flex space-x-2">
              <button 
                onClick={() => navigate('/login')}
                className="flex-1 px-4 py-2 rounded-lg bg-white text-[#6D123F] hover:bg-pink-100 transition-colors"
              >
                Login
              </button>
              <button 
                onClick={() => navigate('/register')}
                className="flex-1 px-4 py-2 rounded-lg border-2 border-white hover:bg-white hover:text-[#6D123F] transition-colors"
              >
                Sign Up
              </button>
            </li>
...
const Footer = () => {
  return (
    <footer className="bg-[#6D123F] text-white py-12">
...
const FeatureCard = ({ title, description, icon }) => (
  <motion.div 
    whileHover={{ y: -5 }}
    className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-[#6D123F]"
  >
    <div className="text-[#8B1752] mb-4 text-4xl">{icon}</div>
    <h3 className="text-xl font-semibold mb-3 text-[#6D123F]">{title}</h3>
...
const Testimonial = ({ quote, author, role, company }) => (
  <motion.div 
    ...
    className="bg-white p-6 rounded-xl shadow-md border-l-4 border-[#6D123F]"
  >
    <div className="mb-4 text-[#8B1752] text-2xl">"</div>
    <p className="italic text-gray-700 mb-4">{quote}</p>
    <div className="flex items-center">
      <div className="bg-[#6D123F] text-white rounded-full w-10 h-10 flex items-center justify-center font-bold mr-3">
        {author.charAt(0)}
      </div>
      <div>
...
const BenefitItem = ({ title, description, icon }) => (
  ...
  >
    <div className="mr-4 text-[#8B1752] mt-1">
      {icon}
    </div>
    <div>
      <h3 className="font-semibold text-lg mb-2 text-pink-400">{title}</h3>
...
const StatCounter = ({ value, label, icon }) => (
  ...
  >
    <div className="inline-flex items-center justify-center w-16 h-16 bg-[#8B1752] rounded-full text-white mb-4">
      {icon}
    </div>
    <div className="text-4xl font-bold text-[#6D123F] mb-2">{value}+</div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-16">
        ...
        <section className="relative bg-[#6D123F] text-white py-24 overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex flex-col lg:flex-row items-center">
              <div className="lg:w-1/2 text-center lg:text-left">
                ...
                >
                  Modern Pharmacy <br />
                  <span className="text-pink-200">Lab Management</span>
                </motion.h1>
                <motion.p 
                  initial={{ opacity: 0, y: -20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <motion.button 
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={() => navigate('/register')}
                    className="bg-white text-[#6D123F] px-8 py-3 rounded-full font-semibold text-lg shadow-md hover:bg-pink-100 transition-colors"
                  >
                    Get Started
                  </motion.button>
                  <motion.button 
                    ...
                    className="border-2 border-white px-8 py-3 rounded-full font-semibold text-lg hover:bg-white hover:text-[#6D123F] transition-colors"
                  >
                    Watch Demo
                  </motion.button>
                </motion.div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-[#6D123F] mb-4">Powerful Features</h2>
        ...
        {/* Benefits Section */}
        <section className="py-20 bg-gradient-to-r from-[#6D123F] to-[#8B1752] text-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col lg:flex-row items-center">
              <motion.div 
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-[#6D123F] mb-12">
              What Our Users Say
            </h2>
        ...
        {/* Newsletter Section */}
        <section className="py-20 bg-[#6D123F]">
          <div className="container mx-auto px-4 text-center text-white">
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto flex gap-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="submit"
                className="bg-white text-[#6D123F] px-6 py-2 rounded-lg font-semibold hover:bg-pink-100 transition-colors"
              >
                Subscribe
              </motion.button>
            </form>
